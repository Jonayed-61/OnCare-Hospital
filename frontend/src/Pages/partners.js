...
import '../Styles/partners.css'; // Make sure this file exists at this path
                    ...
                    <div className="partners-cta-content" data-aos="fade-up">
                        ...
                        <div className="partners-cta-buttons">
                            <button
                                ...
                                onClick={() => navigate('/PartnershipApplication')}
                            >
                                <FaUserMd className="doctors-cta-btn-icon" />  Apply for Partnership
                            </button>
