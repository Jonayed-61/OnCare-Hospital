...
const PartnersPage = () => {
    ...
    // Custom Footer Component for Partners Page
    const PartnersFooter = () => (
        <footer className="footer bg-gray-900 text-white pt-12 pb-6">
            <div className="partners-container">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div>
                        <img src={logo} alt="MediSheba Logo" className="h-12 mb-4" />
                        <p className="text-gray-300">Your health is our priority. Partnering with the best healthcare providers in Bangladesh.</p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-300 hover:text-blue-400 transition-colors">Partners</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-blue-400 transition-colors">Contact Us</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-blue-400">For Partners</h3>
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-300 hover:text-blue-400 transition-colors">Partner Portal</a></li>
                ...
                <div className="border-t border-gray-700 pt-6 text-center text-gray-400">
                    <p>© {new Date().getFullYear()} MediSheba. All rights reserved</p>
                </div>
            </div>
        </footer>
    );
